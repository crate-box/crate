  ...
  (
    ...
    return (
      <RadixPopover.Content
        ref={ref}
        className={cn(
          "data-[side=bottom]:animate-slideTopAndFade relative z-[100] min-w-[320px] rounded bg-slate-800 p-4 shadow-xl will-change-[opacity,transform] focus:shadow-2xl focus:outline-none focus-visible:outline-none data-[side=left]:animate-slideRightAndFade data-[side=right]:animate-slideLeftAndFade data-[side=top]:animate-slideDownAndFade",
          className
        )}
        {...props}
      />
