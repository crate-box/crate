  ...
  (
    ...
    return (
      <RadixDialog.Content
        ref={ref}
        className={cn(
          "fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-[450px] -translate-x-1/2 -translate-y-1/2 rounded bg-slate-900 p-4 shadow-xl focus:outline-none data-[state=open]:animate-contentShow",
          className
        )}
        {...props}
      />
