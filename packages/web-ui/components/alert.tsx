  ...
  (
    ...
    return (
      <RadixAlert.Overlay
        ...
        className={cn(
          className,
          "fixed inset-0 bg-black/30 data-[state=open]:animate-overlayShow"
        )}
        {...props}
      />
    )
  ...
  (
    ...
    return (
      <RadixAlert.Content
        ref={ref}
        className={cn(
          "focus:outline:none fixed left-1/2 top-1/2 flex max-h-[85vh] w-[90w] max-w-[500px] -translate-x-1/2 -translate-y-1/2 flex-col gap-2 rounded bg-slate-900 p-4 shadow-xl data-[state=open]:animate-contentShow",
          className
        )}
        {...props}
      />
